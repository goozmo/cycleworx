...
<div id="_goo-header-hotlink" class="_goo-header-hotlink">
	<div class="container">
		<div id="_goo-aniLogo-palette">
			<div class="_goo-aniLogo-inner">
				<div id="_goo-layer1" class="_goo-layer">
					<img src="<?php echo get_stylesheet_directory_uri() . '/images/logo-sprocket.png' ?>" alt="layer1" />
				</div>
				<div id="_goo-layer2" class="_goo-layer">
					<img src="<?php echo get_stylesheet_directory_uri() . '/images/logo-skull-red.png' ?>" alt="layer2" />
				</div>
				<div id="_goo-layer3" class="_goo-layer">
					<img src="<?php echo get_stylesheet_directory_uri() . '/images/logo-text-1.png' ?>" alt="layer3" />
				</div>
				<div id="_goo-layer4" class="_goo-layer">
					<img src="<?php echo get_stylesheet_directory_uri() . '/images/logo-text-2.png' ?>" alt="layer4" />
				</div>
			</div>
		</div>
		<div class="_goo-full-address" itemscope itemtype="http://schema.org/LocalBusiness">
			<ul itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
				<li class="_goo-title"><span itemprop="name">LTD Cycleworx</span></li>
				<li class="_goo-street" itemprop="streetAddress">5360 Arapahoe Ave</li>
				<li class="_goo-local"><span itemprop="addressLocality">Boulder</span>, <span itemprop="addressRegion">CO</span> <span itemprop="postalCode">80303</span></li>
				<li class="_goo-contact"><span itemprop="telephone">(303) 442-3283</span> - <span>info@ltdcycleworx.com</span></li>
			</ul>
		</div>
		<div class="_goo-full-menu">
			<i class="_quo-fast-button fa fa-bars"></i>
		</div>
	</div>
