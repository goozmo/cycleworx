...
candyjar.api.evScrollFunc = function( callback ){
	...
	function setup(){
		...
		this.mouseWheelActive = mouseWheelActive;
		this.count = count;
	...
	function mouseScroll( ev ){
		...
		if( ev.wheelDelta ){
			mouseDelta = ev.wheelDelta / 120;
			// console.log( this.mouseDelta );
		}
		else if( ev.detail ){
			mouseDelta = -ev.detail / 3;
			// console.log( this.mouseDelta );
		}
	};
	...
	function getData(){
		return{
			...
			mouseWheelActive : this.mouseWheelActive,
			count : this.count,
	...
	function animationLoop(){
		// console.log( "I am here: " + getData().scrolling );
		if( scrolling == true ){
			// console.log( "A: " + scrolling );
			scrolling = false;
			callback.call();
			// console.log( "B: " + scrolling );
		}
		if( mouseWheelActive == true ){
			// console.log( count )
